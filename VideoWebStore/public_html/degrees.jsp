...
<%
	...
	String sql = "Select * from Video where ActorName like '%" + actor1 + "%' or ActorName like '%" + actor2 + "%'";
	out.println(Helper.tablesToString(Select.from(new Video()).execute(con.stmt, sql).queryResults));	
	con.closeConnection();
